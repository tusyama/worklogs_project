...
const SEED_ENTRIES: SeedEntryInput[] = [
  ...
  },
  {
    ...
    workTypeName: "Бетонирование фундамента",
    volume: 18.2,
    performerName: "Козлов Д.И.",
  },
  {
    completedAt: "2026-04-05",
    workTypeName: "Армирование плиты",
    volume: 3.8,
    performerName: "Никитин П.С.",
  },
  {
    completedAt: "2026-04-07",
    workTypeName: "Гидроизоляция",
    volume: 120,
    performerName: "Федорова Е.М.",
  },
  {
    completedAt: "2026-04-10",
    workTypeName: "Монтаж окон",
    volume: 12,
    performerName: "Громов И.К.",
  },
  {
    completedAt: "2026-04-12",
    workTypeName: "Штукатурка стен",
    volume: 95,
    performerName: "Белова О.Н.",
  },
  {
    completedAt: "2026-04-14",
    workTypeName: "Устройство стяжки",
    volume: 68,
    performerName: "Орлов М.А.",
  },
  {
    completedAt: "2026-04-16",
    workTypeName: "Прокладка электрики",
    volume: 240,
    performerName: "Власов Н.Г.",
  },
  {
    completedAt: "2026-04-18",
    workTypeName: "Монтаж сантехники",
    volume: 6,
    performerName: "Данилова Т.Р.",
  },
  {
    completedAt: "2026-04-20",
    workTypeName: "Монтаж опалубки",
    volume: 156,
    performerName: "Егоров В.Л.",
  },
  {
